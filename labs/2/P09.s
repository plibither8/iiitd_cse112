...
P09: 							@ define new procedure with name "P09"
	stmfd	sp!, {r4-r7, lr}	@ push the arguments (list of specified registers) in the stack
	...
	ldmfd	sp!, {r4-r7, pc}	@ pop the arguments from the stack into the mentioned registers
